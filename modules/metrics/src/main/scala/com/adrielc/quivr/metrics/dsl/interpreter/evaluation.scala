...
object evaluation {
  ...
  def compileToEvaluator[A, B](fab: FreeArrow[ACP, EvalOp, A, B], describe: MetricKeyBuilder): A => NonEmptyMap[String, Either[EvalErr, B]] =
  ...
  def compileToFunction[A, B](fab: FreeArrow[AC, EvalOp, A, B], describe: MetricKeyBuilder): A => (String, EvalResult[B]) = {
